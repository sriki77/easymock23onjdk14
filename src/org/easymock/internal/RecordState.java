...
public class RecordState implements IMocksControlState {
    ...
    private static Map primitiveToWrapperType = new HashMap();
    ...
    public java.lang.Object invoke(Invocation invocation) {
        closeMethod();
        List lastMatchers = LastControl.pullMatchers();
    ...
    public void setDefaultThrowable(Throwable throwable) {
        ...
        behavior.addStub(lastInvocation.withMatcher(MockControl.ALWAYS_MATCHER), Result
    ...
    public void times(Range range) {
        ...
        behavior.addExpected(lastInvocation, lastResult != null ? lastResult : Result.createReturnResult(null),
                range);
        lastInvocationUsed = true;
        lastResult = null;
    }
    ...
    private void requireAssignable(Object returnValue) {
        ...
        if (returnedType.isPrimitive()) {
            returnedType = (Class) primitiveToWrapperType.get(returnedType);
